      ...
      <div className="space-y-4">
        {assessments.map(a => (
          <Link
            ...
            className="relative block p-6 rounded-3xl border border-[var(--border-soft)] hover:border-[var(--primary)] hover:shadow-lg transition-all bg-[var(--surface)] overflow-hidden shadow-sm"
          >
