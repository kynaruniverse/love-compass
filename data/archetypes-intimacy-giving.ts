...
export const INTIMACY_GIVING_ARCHETYPES: Record<string, Archetype> = {
  ...
  C: {
    ...
    tryThis: [
      "Check in occasionally. 'Is this good?' or 'what do you want?' ensures your confidence stays connected to your partner's present experience.",
  ...
  D: {
    ...
    narrative: [
      "You build it before you arrive. A message that makes clear you've been thinking about them. A deliberate move that shows you've been anticipating this. The particular energy of being sought out, not just welcomed when you show up, but actively wanted in the hours before. You understand that desire, at its most powerful, lives in the space between moments, and you fill that space intentionally.",
  ...
  G: {
    ...
    partnerNeeds: [
      "A partner whose primary intimacy language is Confidence and Growth Support. They'll feel desired in exactly the way they most need.",
  ...
  H: {
    ...
    partnerNeeds: [
      "A partner whose primary intimacy language is Shared Effort and Equality. They'll feel most desired when the investment is genuinely mutual.",
